...
export async function saveChapters(chapters: Chapter[], outputDir: string): Promise<string[]> {
...
export async function saveParaphrased(chapterIndex: number, output: string, outputDir: string): Promise<string> {
  await ensureDir(outputDir);
